...
const AllPartiesPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div id="all-parties">
        <h1 className="text-5xl font-display text-center mb-4 text-white">כל המסיבות</h1>
        <p className="text-center text-jungle-text/80 mb-8">מצאו את הבילוי הבא שלכם בג'ונגל העירוני</p>
