...
const AboutPage: React.FC = () => {
  return (
    <>
      <SeoManager title="אודות - Party 24/7" description="הסיפור של Party 24/7 - איך הפכנו למקור מספר אחת לחיי הלילה בישראל." />
      <div className="max-w-4xl mx-auto text-jungle-text/90">
        ...
        <div className="space-y-6 bg-jungle-surface p-8 rounded-lg border border-wood-brown/50">
          <p className="text-lg">
            Party 24/7 נולד מתוך תשוקה אמיתית למוזיקה, ריקודים וחיבור בין אנשים. ראינו את סצנת חיי הלילה בישראל, תוססת ומלאת אנרגיה, אבל גם מפוזרת וקשה לניווט. החלום שלנו היה ליצור מקום אחד, פלטפורמה מרכזית שתאחד את כל המסיבות, הרייבים והפסטיבלים הכי שווים, ותנגיש אותם לקהל הרחב בצורה פשוטה, נוחה ומהנה.
          </p>
          <p>
