...
const legalContent = {
  terms: {
    title: 'תנאי שימוש',
    description: 'תנאי השימוש של אתר Party 24/7.',
    content: (
      <>
        <p>ברוכים הבאים ל-Party 24/7. השימוש באתר ובשירותיו כפוף לתנאים המפורטים להלן. אנא קראו אותם בעיון.</p>
        ...
        <p>כל התכנים באתר, לרבות טקסט, תמונות ועיצוב, הינם רכושו של Party 24/7 ואין לעשות בהם שימוש ללא אישור מפורש בכתב.</p>
      </>
    )
  },
  privacy: {
    title: 'מדיניות פרטיות',
    description: 'מדיניות הפרטיות של אתר Party 24/7.',
    content: (
      <>
  ...
  accessibility: {
    title: 'הצהרת נגישות',
    description: 'הצהרת הנגישות של אתר Party 24/7.',
    content: (
      <>
        <p>אנו ב-Party 24/7 רואים חשיבות עליונה בהנגשת האתר שלנו לאנשים עם מוגבלויות, על מנת לאפשר לכלל האוכלוסייה לגלוש בנוחות ובקלות.</p>
...
const LegalPage: React.FC<LegalPageProps> = ({ pageType }) => {
  ...
  return (
    <>
      <SeoManager title={`${title} - Party 24/7`} description={description} />
