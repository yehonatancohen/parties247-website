      ...
      <div className="space-y-8 mb-14">
        {impulseLinks.map((item) => (
          <section
            key={item.anchor}
            id={item.anchor}
            className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-jungle-surface/85 via-jungle-deep/80 to-emerald-900/40 p-6 md:p-8 shadow-[0_18px_45px_rgba(0,0,0,0.32)]"
          >
