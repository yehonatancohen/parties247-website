...
**Data range analyzed:** 2026-07-01 → 2026-07-28 (GSC lag: latest available row is 07-28)
...
| Metric | Value | Trend |
|---|---|---|
| Total Clicks (28d) | ~691 | ↑ Up from ~561 last cycle |
| Total Impressions (28d) | ~12,113 | ↑ Up from ~9,660 last cycle |
| Avg CTR | ~5.7% | → Flat vs last cycle |
| Avg Position | ~8–15 (best days 07-23/07-24: 8.4–9.0) | ↑ Tighter/better than the 8–19 spread last cycle |
| Sitemap Pages Submitted | 428, 0 errors | ↑ Up from 374 — expected, archive-page tail growing as more events pass |
| Sitemap Pages Indexed | 0 (API) | → Known API quirk; `index_inspect` spot check on `/club/jimmy-who` this cycle confirms "Submitted and indexed", crawled 07-30 — trust the GSC dashboard/inspection tool, not the sitemap API field |
