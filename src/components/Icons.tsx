...
export const TikTokIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.03-4.83-1.1-6.42-3.02-1.55-1.87-2.15-4.29-1.85-6.62.33-2.61 1.82-4.88 4.12-6.04.95-.49 2-.8 3.03-.97.02-1.52.01-3.04.01-4.57.01-1.56.52-3.1 1.58-4.26 1.06-1.16 2.53-1.85 4.11-1.98a.12.12 0 0 1 .11.11c.02.02.02.06.01.09-.09.1-.18.2-.28.3-.76.75-1.24 1.76-1.21 2.85.03 1.11.56 2.18 1.43 2.91.86.73 1.95 1.16 3.09 1.25.07.01.14.01.21.02.01-.02-.01-.06 0-.08v.01c-.02-.01-.03-.02-.05-.03-1.4-.23-2.69-.96-3.52-2.12-.8-1.12-1.04-2.58-.9-4.04.13-1.42.66-2.81 1.63-3.92z"/>
    </svg>
);
...
export const ShareIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.582.042h10.5a2.25 2.25 0 012.25 2.25v0a2.25 2.25 0 01-2.25 2.25h-10.5a2.25 2.25 0 01-2.009-1.134M7.217 10.907a2.25 2.25 0 012.25-2.25h10.5a2.25 2.25 0 012.25 2.25v0a2.25 2.25 0 01-2.25 2.25h-10.5a2.25 2.25 0 01-2.009-1.134" />
  </svg>
);
