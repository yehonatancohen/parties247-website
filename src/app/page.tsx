...
export const metadata: Metadata = {
  title: 'כרטיסים למסיבות תל אביב 2026 – טכנו, האוס ומיינסטרים | Parties24/7',
  description: 'מצאו כרטיסים למסיבות הקרובות בתל אביב ובישראל – טכנו, האוס, היפ-הופ ופסטיבלים. ליינאפ מעודכן, קישורי רכישה ישירים.',
  alternates: {
    canonical: '/',
    languages: { 'he-IL': '/' },
  },
