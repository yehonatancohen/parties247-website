...
const staticPages: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/halloween`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
  { url: `${BASE_URL}/hanukkah`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
  { url: `${BASE_URL}/sylvester`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
  { url: `${BASE_URL}/purim`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.6 },
  { url: `${BASE_URL}/yom-haatzmaut`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.6 },
