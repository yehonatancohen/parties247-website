...
export const SPECIFIC_PARTIES_PAGES: SeoPageConfig[] = [
  ...
  // ========================================================
  {
    ...
    title: 'מסיבות 18 פלוס בתל אביב',
    description: 'מסיבות 18 פלוס בתל אביב – אירועים לצעירים בברים, מועדוני לילה ומסיבות חוץ. כרטיסים מוקדמים, ליינים ועדכונים שוטפים.',
